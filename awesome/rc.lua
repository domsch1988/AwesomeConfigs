...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn("st ranger")  end,
              {description = "Ranger", group = "Programms"}),
    awful.key({ modkey },            "e",     function () awful.util.spawn("st gcalcli calm --hold")  end,
              {description = "Ranger", group = "Programms"}),
